...
# -*- coding: utf-8 -*-
#
# py-probstructs documentation build configuration file, created by
...
project = 'ProbStructs'
copyright = '2020, <a href="http://martin.majlis.cz">Martin Majlis</a>'
...
htmlhelp_basename = 'py-probstructs'
...
latex_documents = [
    (master_doc, 'py-probstructs.tex', 'py-probstructs Documentation',
...
man_pages = [
    (master_doc, 'py-probstructs', 'py-probstructs Documentation',
     [author], 1)
]
...
html_context = {
    ...
    "github_repo": "py-probstructs", # Repo name
